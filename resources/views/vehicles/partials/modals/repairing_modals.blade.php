        ...
        <div class="p-6">
            ...
            <form id="add-repair-form">
                ...
                <div class="mb-4">
                    ...
                    <select id="add-repair-category" name="category_id" class="w-full px-3 py-2 border border-neutral-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500" required>
