            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <form id="vehicle-form" class="space-y-6">
                        ...
                        <!-- Basic Information -->
                        <div>
                            <h3 class="text-lg font-medium text-neutral-900 mb-4">Thông tin cơ bản</h3>
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <p class="mt-1 text-xs text-neutral-500 ">Số thứ tự của xe Gokart</p>
                                </div>
                                ...
                                <div>
                                    <label for="seats" class="block text-sm font-medium text-neutral-700  mb-2">
                                ...
                                <div>
                                    <label for="power" class="block text-sm font-medium text-neutral-700  mb-2">
                                ...
                                <div>
                                    <label for="wheel_size" class="block text-sm font-medium text-neutral-700  mb-2">
                        ...
                        <div>
                            <h3 class="text-lg font-medium text-neutral-900  mb-4">Thông tin bổ sung</h3>
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    <label for="current_location" class="block text-sm font-medium text-neutral-700  mb-2">
                                        Vị trí hiện tại
                                    </label>
                        ...
                        <div class="flex justify-end space-x-3 pt-6 border-t border-neutral-200 ">
                            <a href="{{ route('vehicles.index') }}" 
                               class="px-6 py-2 bg-neutral-300  hover:bg-neutral-400  text-neutral-700  font-semibold rounded-md transition-colors duration-200">
                                Hủy
                            </a>
                            <button type="submit" 
