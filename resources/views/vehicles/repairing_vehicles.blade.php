                    ...
                    <tr class="hover:bg-gray-50" data-issue-id="{{ $issue->id }}">
                            ...
                            <div class="text-sm text-gray-900">
                                @if($issue->description)
                                    @if(strlen($issue->description) > 50)
                                        ...
                                        <button onclick="openRepairDescriptionModal('{{ addslashes($issue->description) }}', '{{ addslashes($issue->notes ?? '') }}')" class="text-blue-600 hover:text-blue-900 ml-1" title="Xem chi tiết">
                        ...
                        <td class="px-4 py-4 whitespace-nowrap text-sm font-medium">
                            <div class="flex space-x-2">
                                ...
                                @endif
                                <button onclick="openRepairProcessModal({{ $issue->id }})" class="text-blue-600 hover:text-blue-900" title="Xử lý">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div class="md:hidden space-y-4">
        ...
        <div class="bg-white rounded-lg shadow-md p-4" data-issue-id="{{ $issue->id }}">
            ...
            <div class="flex justify-end space-x-2 mt-3 pt-3 border-t border-gray-200">
                ...
                @endif
                <button onclick="openRepairProcessModal({{ $issue->id }})" class="text-blue-600 hover:text-blue-900 p-1" title="Xử lý">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.065 2.572c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.572 1.065c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 00-1.065-2.572c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.07 2.572-1.065z"></path>
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                    </svg>
