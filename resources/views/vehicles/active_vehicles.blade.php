<!-- Active Vehicles Display - Xe ngoài bãi (active, running, expired, paused, route) -->
<div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
    <div class="p-6">
        <div class="mb-4">
            <h3 class="text-lg font-semibold text-neutral-900">Xe ngoài bãi</h3>
            <p class="text-sm text-neutral-600">Hiển thị tất cả xe không trong xưởng</p>
        </div>
