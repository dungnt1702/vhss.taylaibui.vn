...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::get('/vehicles/attributes', [AttributesListController::class, 'index'])->name('vehicles.attributes');
    Route::get('/vehicles/attributes/page/{page}', [AttributesListController::class, 'index'])->name('vehicles.attributes.page');
